(function (global, factory) {
        ...
        _c(
          ...
          [
            ...
            _vm._l(_vm.states, function(item) {
              return _c("option", [_vm._v(_vm._s(item.state.name))])
            })
          ],
          2
        ),
          ...
          "select",
          {
            ...
            on: {
              change: function($event) {
                ...
                _vm.lga = $event.target.multiple ? $$selectedVal : $$selectedVal[0];
              }
            }
          },
          [
            _c("option", [_vm._v("Select LGA")]),
            _vm._v(" "),
            _vm._l(_vm.lgas, function(lga) {
              return _c("option", [_vm._v(_vm._s(lga.name))])
            })
          ],
          2
        )
    ...
    __vue_render__._withStripped = true;
      ...
      function __vue_normalize__(
        ...
        component.__file = "C:\\Users\\Justin\\Desktop\\vue-naija-states-lgas\\src\\StatesLgas.vue";
      ...
      var StatesLgas = __vue_normalize__(
    ...
    function install(Vue) {
        ...
        Vue.component('NaijaStatesLgas', StatesLgas);
    }
